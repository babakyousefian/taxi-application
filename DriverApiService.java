...
public class DriverApiService {
    ...
    public interface DriverApi {
        ...
        //method that authenticate the driver (sign in) using his telephone number and country code
        @POST("authDriverTelNumber")
        Call<ResponseBody> authDriverTelNumber(@Query("country_code") String countryCode,
                                               @Query("tel_number") String tel_number);
        ...
        Call<ResponseBody> updatePositionSpeed(@Query("id") Integer id,
                                          @Query("secretKey") String secretKey,
                                          @Query("last_latitude") Double last_latitude,
                                          @Query("last_longitude") Double last_longitude,
        ...
        @POST("checkInOut")
        Call<ResponseBody> checkInOutChild(@Query("driver_id") Integer driver_id,
                                           @Query("secretKey") String secretKey,
